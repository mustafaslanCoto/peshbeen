...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/var.py#L35"
...
def var(
    ...
    box_cox:Optional[Dict[str, bool]]=None, # Dictionary specifying whether to apply Box-Cox transformation to each target variable. Values are booleans indicating whether to apply the transformation.
    box_cox_lmda:Optional[Dict[str, float]]=None, # Dictionary specifying the lambda parameter for Box-Cox transformation for each target variable. Values are floats indicating the lambda to use for the transformation. If not provided, lambda will be estimated from the data.
    box_cox_biasadj:Any=False, # Bias adjustment to apply after inverting the Box-Cox transformation. Can be a single boolean applied to all targets or a dictionary specifying the bias adjustment for each target. If True, applies bias adjustment; if False, no adjustment is made. If a dictionary is provided, values should be booleans indicating whether to apply bias adjustment for each target variable.
...
each target variable. Values are booleans indicating whether to apply
...
transformation for each target variable. Values are floats indicating
the lambda to use for the transformation. If not provided, lambda will
be estimated from the data.</td>
</tr>
<tr>
<td>box_cox_biasadj</td>
<td>Any</td>
<td>False</td>
<td>Bias adjustment to apply after inverting the Box-Cox transformation.
Can be a single boolean applied to all targets or a dictionary
specifying the bias adjustment for each target. If True, applies bias
adjustment; if False, no adjustment is made. If a dictionary is
provided, values should be booleans indicating whether to apply bias
adjustment for each target variable.</td>
</tr>
<tr>
<td>add_constant</td>
<td>bool</td>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/var.py#L264"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/var.py#L364"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/var.py#L482"
target="_blank" style="float:right; font-size:smaller">source</a>
