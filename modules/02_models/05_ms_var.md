...
def ms_var(
    ...
    box_cox:Optional[Dict[str, bool]]=None, # Dictionary specifying whether to apply Box-Cox transformation to each target variable. The keys are target column names, and the values are booleans indicating whether to apply the transformation.
    box_cox_lmda:Optional[Dict[str, float]]=None, # Dictionary specifying the lambda parameter for Box-Cox transformation for each target variable. The keys are target column names, and the values are floats indicating the lambda to use (if None, it will be estimated from the data).
...
each target variable. The keys are target column names, and the values
are booleans indicating whether to apply the transformation.</td>
</tr>
<tr>
<td>box_cox_lmda</td>
<td>Optional[Dict[str, float]]</td>
<td>None</td>
<td>Dictionary specifying the lambda parameter for Box-Cox
transformation for each target variable. The keys are target column
names, and the values are floats indicating the lambda to use (if None,
it will be estimated from the data).</td>
</tr>
<tr>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/ms_var.py#L481"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/ms_var.py#L625"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/ms_var.py#L916"
target="_blank" style="float:right; font-size:smaller">source</a>
