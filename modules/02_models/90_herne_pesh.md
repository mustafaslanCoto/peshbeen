...
def cross_validate(
    ...
    metrics:List[Callable], # A metric function or a list of metric functions to evaluate the forecasts. Each function should take the true values and forecasted values as input and return a scalar performance metric.
...
<td>List[Callable]</td>
<td></td>
<td>A metric function or a list of metric functions to evaluate the
forecasts. Each function should take the true values and forecasted
values as input and return a scalar performance metric.</td>
</tr>
<tr>
<td>step_size</td>
<td>int</td>
