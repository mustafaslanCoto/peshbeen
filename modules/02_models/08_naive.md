...
`forecast` returns an array of `NaN`. | | box_cox | Union\[bool, float\]
| False | Whether to apply Box-Cox transformation to the target
variable. If a float value is provided, it will be used as the lambda
parameter for the Box-Cox transformation. If True, the lambda parameter
will be estimated from the data. | | box_cox_biasadj | bool | False |
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/naive.py#L105"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/naive.py#L168"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/mustafaslanCoto/peshbeen/blob/main/peshbeen/models/naive.py#L229"
target="_blank" style="float:right; font-size:smaller">source</a>
