...
::: {#ef1fdc89 .cell 0='e' 1='x' 2='p' 3='o' 4='r' 5='t'}
``` {.python .cell-code}
...
ml_linear = ml_mv_forecaster(model=LGBMRegressor(verbose=-1),
              ...
              box_cox=False, box_cox_biasadj=True,
...
plt.plot(train.index[-90:], ml_linear.fitted_values['admissions'][-90:], label='Train Fitted', color='orange', linestyle='--')
...
![](03_ml_mv_forecast_files/figure-html/cell-4-output-1.png){}
:::
:::


::: {#84d99a6f .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
...
::: {.cell-output .cell-output-display}
![](03_ml_mv_forecast_files/figure-html/cell-5-output-1.png){}
:::
:::


::: {#92c415a3 .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
from peshbeen.metrics import WMAPE, MAE, RMSE
mtrcs = [WMAPE, MAE, RMSE]
cvdf = ml_linear.cross_validate(df=admission_calls, target_col='calls', cv_split=3, test_size=30, metrics=mtrcs, h_split_point=15)
```
:::
