...
ml_linear = ml_forecaster(model=HistGradientBoostingRegressor(),
...
![](01_ml_forecast_files/figure-html/cell-4-output-1.png){}
:::
:::


::: {#3148dbe1 .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
