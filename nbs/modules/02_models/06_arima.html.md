...
::: {#4cd61f38 .cell 0='e' 1='x' 2='p' 3='o' 4='r' 5='t'}
``` {.python .cell-code}
...
![](06_arima_files/figure-html/cell-4-output-1.png){}
:::
:::


::: {#ec86bfab .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
...
::: {.cell-output .cell-output-display}
![](06_arima_files/figure-html/cell-5-output-1.png){}
:::
:::


::: {#9015af7f .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
