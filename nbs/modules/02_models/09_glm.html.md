...
::: {#47f19939 .cell 0='e' 1='x' 2='p' 3='o' 4='r' 5='t'}
``` {.python .cell-code}
...
# train_y = data.endog[:25].to_numpy()
# train_X = data.exog[:25].to_numpy()

# test_y = data.endog[25:].to_numpy()
# test_X = data.exog[25:].to_numpy()

# # Instantiate a gamma family model with the default link function.
# gamma_model = sm.GLM(train_y, train_X, family=sm.families.Poisson())

# gamma_results = gamma_model.fit()
my_fam = sm.families.NegativeBinomial()
...
![](09_glm_files/figure-html/cell-4-output-1.png){}
:::
:::


::: {#c27cd082 .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
