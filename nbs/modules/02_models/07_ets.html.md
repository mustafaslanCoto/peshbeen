...
::: {#928028da .cell 0='e' 1='x' 2='p' 3='o' 4='r' 5='t'}
``` {.python .cell-code}
...
ets_model.fit(train)
ets_model.predict_in_sample()
ets_forecast = ets_model.forecast(30)
ets_forecast
# plotting
import matplotlib.pyplot as plt
plt.figure(figsize=(12, 6))
plt.plot(train.index[-90:], train["admissions"][-90:], label="Train", color="blue")
plt.plot(train.index[-90:], ets_model.fitted_values[-90:], label='Train Fitted', color='orange')
plt.plot(test.index, test["admissions"], label="Test", color="orange")
...
![](07_ets_files/figure-html/cell-4-output-1.png){}
:::
:::


::: {#e87f2acf .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
xx = ets_model.cross_validate(
    df=wales_admissions,
    cv_split=3,
    test_size=30,
    metrics=[MAE, RMSE],
    step_size=2, h_split_point=15,)
ets_model.cv_summary
```
