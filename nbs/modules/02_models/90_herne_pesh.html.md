...
::: {#e24c1087 .cell 0='e' 1='x' 2='p' 3='o' 4='r' 5='t'}
``` {.python .cell-code}
...
dfs = {name: train for name in models.keys()}
# models = {"lgb": lgb_, "xgb": xgb_, "rf": rf_, "lr": lr_}
pesh_model = pesh(models=models)
perf_df = pesh_model.cross_validate(df=dfs, cv_split=5, test_size=30, step_size=30, metrics=[MAE, RMSE], metric_to_opt=RMSE, weighting_scheme="optimize")

```
:::


::: {#1ec89b81 .cell 0='h' 1='i' 2='d' 3='e'}
``` {.python .cell-code}
